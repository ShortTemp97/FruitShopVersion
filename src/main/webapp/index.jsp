							...
							<ul>
								...
								<!--<c:forEach var="cart" items="kart">-->
									<div class="header-icons">
										<a class="shopping-cart" href="viewCart"><i class="fas fa-shopping-cart"><c:out value="${kart.size()}"></c:out> </i></a>
				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							...
							<div class="hero-btns">
								<a href="shop.jsp" class="boxed-btn">All Fruits</a>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						...
						<p>We offer Fresh and Healthy Fruits</p>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.jsp"><img src="${item.getImages()}" alt="${item.getItemName()}"></a>
						</div>
						<h3><c:out value="${item.getItemName()}"></c:out> </h3>
						<p class="product-price"><span>Price :<c:out value="${item.getPrice()}"></c:out> </span> </p>
						<a href="cart?id=${item.getItemId()}" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
			</c:forEach>
	...
	<div class="abt-section mb-150">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						<p class="top-sub">Since Year 1704</p>
						<h2>We are <span class="orange-text">Fruitkha</span></h2>
<!--Text can be edited  -->	<p>Etiam vulputate ut augue vel sodales. In sollicitudin neque et massa porttitor vestibulum ac vel nisi. Vestibulum placerat eget dolor sit amet posuere. In ut dolor aliquet, aliquet sapien sed, interdum velit. Nam eu molestie lorem.</p>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box get-in-touch">
						...
						<ul>
							<li>34/8, East Hakimpet, Hyderabad, India.</li>
							<li>support@fruitkha.com</li>
							<li>+91 111 2220000s</li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
